...
2. Download this [repo](https://github.com/vitaliyy-turovskiyy/Postman-newman-ghActions.git).
 ...
 * Add Github action to run `petstore.collection.json` in Github pages by <a href="https://www.linkedin.com/pulse/running-postman-collections-via-github-action-nirmala-jayasanka"> article </a> or use another GH action.
 * Check github actions for result.
